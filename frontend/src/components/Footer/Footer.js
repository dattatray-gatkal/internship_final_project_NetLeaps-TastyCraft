      ...
      <footer className={classes.footer}>
        <div className={classes.footer_main}>
          ...
          <div className={classes.footer_tag}>
            <h2>Quick Link</h2>
            <p>
              <Link to="/" className={classes.footer_text}>
                Home
              </Link>
            </p>
            <p>
              <Link to="/about" className={classes.footer_text}>
                About
              </Link>
            </p>
            <p>
              <Link to="/profile" className={classes.footer_text}>
                Profile
              </Link>
            </p>
            {/* <p>Gallary</p> */}
            <p>
              <Link to="/order" className={classes.footer_text}>
                Orders
              </Link>
            </p>
          </div>
          ...
          <div className={classes.footer_tag}>
            ...
            <br></br>
            <a
              href="http://www.linkedin.com/in/netleap-it-training-and-solutions-6b41b31a0"
              target="_blank"
              aria-label="Twitter"
            >
              <svg
